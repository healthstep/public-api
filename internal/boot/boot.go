...
func Run(ctx context.Context) error {
	...
	resty.Endpoint(router, requests.NewAdminDeleteRecommendationRequest, healthCtrl.AdminDeleteRecommendation, jwtMW)
		...
		resty.Endpoint(router, requests.NewAdminListAnalysesRequest, healthCtrl.AdminListAnalyses, jwtMW)
		resty.Endpoint(router, requests.NewAdminUpsertAnalysisRequest, healthCtrl.AdminUpsertAnalysis, jwtMW)
		resty.Endpoint(router, requests.NewAdminDeleteAnalysisRequest, healthCtrl.AdminDeleteAnalysis, jwtMW)
